...
public class JSONTask extends AsyncTask<String, String, TrackModel> {
    ...
    protected void onPostExecute(TrackModel result) {
        ...
        //TODO choose a specific track
        result.chooseTrack(0);
        System.out.println("Track Chosen");
        MainActivity.mPlayer.queueTrack(result);
        System.out.println("Track Queued/Played");
    }
}
